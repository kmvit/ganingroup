...
class SiteSettings(models.Model):
    ...
    noindex = models.BooleanField(
        'Закрыть сайт от поисковиков', default=True,
        help_text='Пока включено — сайт не индексируется (meta noindex на всех '
                  'страницах + robots.txt Disallow). Снимите галочку при запуске '
                  'на рабочем домене, чтобы сайт попал в поиск')
