...
class SiteSettings(models.Model):
    ...
    map_embed_url = models.URLField(
        ...
        help_text='Карта на «Контактах» и главной. Свою карту (с зоной доставки, '
                  'несколькими метками) можно собрать в Конструкторе карт Яндекса '
                  'и вставить сюда ссылку из кнопки «Получить код» (адрес из src). '
                  'Пусто — вернётся схема-заглушка вёрстки')
